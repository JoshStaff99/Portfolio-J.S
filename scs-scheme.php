...
<html lang="en">
    <head>
        <title>Portfolio J.S SCS Scheme</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <main>
            <div class="scs-scheme-page-container">
                <div class="section-container scs-scheme-container">
                ...
                <div class="section-container netmatters-container">
                ...
                <div class="section-container treehouse-container">
                    <h3>Treehouse</h3>
                    <p>Treehouse is an online learning community, featuring videos covering a number of topics from basic HTML to C# programming, iOS development, data analysis, and more. By completing courses users can earn points, allowing them to track their progress and see how much they've covered in certain areas.</p>
                        <p>View Total Score Below</p>
                        <a href="https://teamtreehouse.com/profiles/joshuastafford3" target="_blank"><strong>teamtreehouse.com/course score</strong></a>
                </div>
            </div>
        </main>
